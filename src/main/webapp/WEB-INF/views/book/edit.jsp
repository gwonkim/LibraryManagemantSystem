...
<body>
	<div class="container">
		<form:form method="post" modelAttribute="book">
			<div class="title">자료 ${ book.id > 0 ? "수정" : "등록" }</div>
			<table>
				<tr>
					<td>자료명</td>
				...
				<tr>
					<td>상태:</td>
					<td><form:select path="state.id" itemValue="id"
							itemLabel="state" items="${ staties }" /></td>
				</tr>
				<tr>
					<td>분류:</td>
					<td><form:select path="category.id" itemValue="id"
							itemLabel="name" items="${ categories }" /></td>
				</tr>
			</table>
			<hr />
			<div>
