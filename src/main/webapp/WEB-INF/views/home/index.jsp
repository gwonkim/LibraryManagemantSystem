...
<body>
	...
	<div class="nav">
		<span class="nav_left"> <img src="image/library2.png"
			class="nav_img" />
		</span> <span class="nav_text">지원도서관</span>
		<sec:authorize access="not authenticated">
			<span class="nav_right"> <a href="${R}login" class="nav_link">로그인</a> | <a href="signup" class="nav_link">회원가입</a>
			</span>

		</sec:authorize>
		<sec:authorize access="authenticated">
			<a class="nav_link" href="${R}user/index">사용자 페이지</a>
			<span class="nav_right"> <a href="${R}logout_processing" class="nav_link">로그아웃</a></span>
		</sec:authorize>
	</div>
